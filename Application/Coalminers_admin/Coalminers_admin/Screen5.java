...
public class Screen5 extends Form implements Runnable {
    ...
    static final SimpleSymbol Lit28 = ((SimpleSymbol) new SimpleSymbol("FontTypeface").readResolve());
    static final SimpleSymbol Lit29 = ((SimpleSymbol) new SimpleSymbol("Hint").readResolve());
    ...
    static final SimpleSymbol Lit31 = ((SimpleSymbol) new SimpleSymbol("TextAlignment").readResolve());
    ...
    static final FString Lit35 = new FString("com.google.appinventor.components.runtime.TextBox");
    static final FString Lit36 = new FString("com.google.appinventor.components.runtime.TableArrangement");
    static final SimpleSymbol Lit37 = ((SimpleSymbol) new SimpleSymbol("TableArrangement1").readResolve());
    static final SimpleSymbol Lit38 = ((SimpleSymbol) new SimpleSymbol("Rows").readResolve());
    ...
    static final SimpleSymbol Lit41 = ((SimpleSymbol) new SimpleSymbol("TextBox3").readResolve());
    static final SimpleSymbol Lit42 = ((SimpleSymbol) new SimpleSymbol("Column").readResolve());
    static final SimpleSymbol Lit43 = ((SimpleSymbol) new SimpleSymbol("Row").readResolve());
    static final IntNum Lit44 = IntNum.make(0);
    ...
    static final SimpleSymbol Lit47 = ((SimpleSymbol) new SimpleSymbol("TextBox5").readResolve());
    ...
    static final SimpleSymbol Lit50 = ((SimpleSymbol) new SimpleSymbol("TextBox7").readResolve());
    ...
    static final SimpleSymbol Lit53 = ((SimpleSymbol) new SimpleSymbol("Image1").readResolve());
    static final SimpleSymbol Lit54 = ((SimpleSymbol) new SimpleSymbol("Height").readResolve());
    static final IntNum Lit55 = IntNum.make(-2);
    static final SimpleSymbol Lit56 = ((SimpleSymbol) new SimpleSymbol("Picture").readResolve());
    static final SimpleSymbol Lit57 = ((SimpleSymbol) new SimpleSymbol("Width").readResolve());
    static final IntNum Lit58 = IntNum.make(-1050);
    ...
    static final SimpleSymbol Lit61 = ((SimpleSymbol) new SimpleSymbol("Image2").readResolve());
    ...
    static final SimpleSymbol Lit65 = ((SimpleSymbol) new SimpleSymbol("Image3").readResolve());
    ...
    static final SimpleSymbol Lit69 = ((SimpleSymbol) new SimpleSymbol("Button1").readResolve());
    ...
    static final SimpleSymbol Lit71 = ((SimpleSymbol) new SimpleSymbol("FontSize").readResolve());
    static final IntNum Lit72 = IntNum.make(18);
    static final IntNum Lit73;
    static final FString Lit74 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit75 = ((SimpleSymbol) new SimpleSymbol("get-simple-name").readResolve());
    static final SimpleSymbol Lit76 = ((SimpleSymbol) new SimpleSymbol("android-log-form").readResolve());
    static final SimpleSymbol Lit77 = ((SimpleSymbol) new SimpleSymbol("add-to-form-environment").readResolve());
    static final SimpleSymbol Lit78 = ((SimpleSymbol) new SimpleSymbol("lookup-in-form-environment").readResolve());
    static final SimpleSymbol Lit79 = ((SimpleSymbol) new SimpleSymbol("is-bound-in-form-environment").readResolve());
    static final SimpleSymbol Lit8 = ((SimpleSymbol) new SimpleSymbol("AlignHorizontal").readResolve());
    static final SimpleSymbol Lit80 = ((SimpleSymbol) new SimpleSymbol("add-to-global-var-environment").readResolve());
    static final SimpleSymbol Lit81 = ((SimpleSymbol) new SimpleSymbol("add-to-events").readResolve());
    static final SimpleSymbol Lit82 = ((SimpleSymbol) new SimpleSymbol("add-to-components").readResolve());
    static final SimpleSymbol Lit83 = ((SimpleSymbol) new SimpleSymbol("add-to-global-vars").readResolve());
    static final SimpleSymbol Lit84 = ((SimpleSymbol) new SimpleSymbol("add-to-form-do-after-creation").readResolve());
    static final SimpleSymbol Lit85 = ((SimpleSymbol) new SimpleSymbol("send-error").readResolve());
    static final SimpleSymbol Lit86 = ((SimpleSymbol) new SimpleSymbol("dispatchEvent").readResolve());
    static final SimpleSymbol Lit87 = ((SimpleSymbol) new SimpleSymbol("dispatchGenericEvent").readResolve());
    ...
    static {
        ...
        int[] iArr2 = new int[2];
        iArr2[0] = -256;
        Lit70 = IntNum.make(iArr2);
        int[] iArr3 = new int[2];
        iArr3[0] = -1;
        Lit34 = IntNum.make(iArr3);
        int[] iArr4 = new int[2];
        iArr4[0] = -65536;
    ...
    public Screen5() {
        ...
        frame2.$main = this;
        this.get$Mnsimple$Mnname = new ModuleMethod(frame2, 1, Lit75, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.onCreate = new ModuleMethod(frame2, 2, "onCreate", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = new ModuleMethod(frame2, 3, Lit76, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mnenvironment = new ModuleMethod(frame2, 4, Lit77, 8194);
        this.lookup$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 5, Lit78, 8193);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 7, Lit79, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = new ModuleMethod(frame2, 8, Lit80, 8194);
        this.add$Mnto$Mnevents = new ModuleMethod(frame2, 9, Lit81, 8194);
        this.add$Mnto$Mncomponents = new ModuleMethod(frame2, 10, Lit82, 16388);
        this.add$Mnto$Mnglobal$Mnvars = new ModuleMethod(frame2, 11, Lit83, 8194);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = new ModuleMethod(frame2, 12, Lit84, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.send$Mnerror = new ModuleMethod(frame2, 13, Lit85, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.process$Mnexception = new ModuleMethod(frame2, 14, "process-exception", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.dispatchEvent = new ModuleMethod(frame2, 15, Lit86, 16388);
        this.dispatchGenericEvent = new ModuleMethod(frame2, 16, Lit87, 16388);
        this.lookup$Mnhandler = new ModuleMethod(frame2, 17, Lit88, 8194);
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            Values.writeValues(runtime.setAndCoerceProperty$Ex(Lit0, Lit18, "Worker 3", Lit13), $result);
        } else {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            addToComponents(Lit20, Lit35, Lit23, lambda$Fn6);
        }
        this.TableArrangement1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit0, Lit36, Lit37, lambda$Fn7), $result);
        } else {
            addToComponents(Lit0, Lit39, Lit37, lambda$Fn8);
        }
        this.TextBox3 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit37, Lit40, Lit41, lambda$Fn9), $result);
        } else {
            addToComponents(Lit37, Lit45, Lit41, lambda$Fn10);
        }
        this.TextBox5 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit37, Lit46, Lit47, lambda$Fn11), $result);
        } else {
            addToComponents(Lit37, Lit48, Lit47, lambda$Fn12);
        }
        this.TextBox7 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit37, Lit49, Lit50, lambda$Fn13), $result);
        } else {
            addToComponents(Lit37, Lit51, Lit50, lambda$Fn14);
        }
        this.Image1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit37, Lit52, Lit53, lambda$Fn15), $result);
        } else {
            addToComponents(Lit37, Lit59, Lit53, lambda$Fn16);
        }
        this.Image2 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit37, Lit60, Lit61, lambda$Fn17), $result);
        } else {
            addToComponents(Lit37, Lit63, Lit61, lambda$Fn18);
        }
        this.Image3 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit37, Lit64, Lit65, lambda$Fn19), $result);
        } else {
            addToComponents(Lit37, Lit67, Lit65, lambda$Fn20);
        }
        this.Button1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit0, Lit68, Lit69, lambda$Fn21), $result);
        } else {
            addToComponents(Lit0, Lit74, Lit69, lambda$Fn22);
        }
        runtime.initRuntime();
    }
    ...
    static Object lambda3() {
        ...
        runtime.setAndCoerceProperty$Ex(Lit0, Lit16, "Fixed", Lit13);
        runtime.setAndCoerceProperty$Ex(Lit0, Lit17, "AppTheme.Light", Lit13);
        return runtime.setAndCoerceProperty$Ex(Lit0, Lit18, "Worker 3", Lit13);
    }
    ...
    static Object lambda6() {
        ...
        runtime.setAndCoerceProperty$Ex(Lit23, Lit28, Component.TYPEFACE_SANSSERIF, Lit13);
        runtime.setAndCoerceProperty$Ex(Lit23, Lit29, "Hint for TextBox1", Lit13);
        runtime.setAndCoerceProperty$Ex(Lit23, Lit30, "Data", Lit13);
        runtime.setAndCoerceProperty$Ex(Lit23, Lit31, Lit32, Lit5);
        return runtime.setAndCoerceProperty$Ex(Lit23, Lit33, Lit34, Lit5);
    }
    ...
    static Object lambda8() {
        return runtime.setAndCoerceProperty$Ex(Lit37, Lit38, Lit9, Lit5);
    }
    ...
    static Object lambda10() {
        runtime.setAndCoerceProperty$Ex(Lit41, Lit42, Lit32, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit41, Lit29, "95", Lit13);
        return runtime.setAndCoerceProperty$Ex(Lit41, Lit43, Lit44, Lit5);
    }
    ...
    static Object lambda12() {
        runtime.setAndCoerceProperty$Ex(Lit47, Lit42, Lit32, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit47, Lit29, Component.TYPEFACE_SANSSERIF, Lit13);
        return runtime.setAndCoerceProperty$Ex(Lit47, Lit43, Lit32, Lit5);
    }
    ...
    static Object lambda14() {
        runtime.setAndCoerceProperty$Ex(Lit50, Lit42, Lit32, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit50, Lit29, "Nil", Lit13);
        return runtime.setAndCoerceProperty$Ex(Lit50, Lit43, Lit11, Lit5);
    }
    ...
    static Object lambda16() {
        runtime.setAndCoerceProperty$Ex(Lit53, Lit42, Lit44, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit53, Lit54, Lit55, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit53, Lit56, "heartrate.png", Lit13);
        runtime.setAndCoerceProperty$Ex(Lit53, Lit43, Lit44, Lit5);
        return runtime.setAndCoerceProperty$Ex(Lit53, Lit57, Lit58, Lit5);
    }
    ...
    static Object lambda18() {
        runtime.setAndCoerceProperty$Ex(Lit61, Lit42, Lit44, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit61, Lit54, Lit55, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit61, Lit56, "location.png", Lit13);
        runtime.setAndCoerceProperty$Ex(Lit61, Lit43, Lit32, Lit5);
        return runtime.setAndCoerceProperty$Ex(Lit61, Lit57, Lit62, Lit5);
    }
    ...
    static Object lambda20() {
        runtime.setAndCoerceProperty$Ex(Lit65, Lit42, Lit44, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit65, Lit54, Lit55, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit65, Lit56, "smoek.png", Lit13);
        runtime.setAndCoerceProperty$Ex(Lit65, Lit43, Lit11, Lit5);
        return runtime.setAndCoerceProperty$Ex(Lit65, Lit57, Lit66, Lit5);
    }
    ...
    static Object lambda22() {
        runtime.setAndCoerceProperty$Ex(Lit69, Lit24, Lit70, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit69, Lit26, Boolean.TRUE, Lit7);
        runtime.setAndCoerceProperty$Ex(Lit69, Lit27, Boolean.TRUE, Lit7);
        runtime.setAndCoerceProperty$Ex(Lit69, Lit71, Lit72, Lit5);
        runtime.setAndCoerceProperty$Ex(Lit69, Lit30, "Emergency", Lit13);
        return runtime.setAndCoerceProperty$Ex(Lit69, Lit33, Lit73, Lit5);
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object apply0(ModuleMethod moduleMethod) {
            switch (moduleMethod.selector) {
                ...
                case 37:
                    return Screen5.lambda20();
                case 38:
                    return Screen5.lambda21();
                case 39:
                    return Screen5.lambda22();
                case 40:
                    return Screen5.lambda23();
                default:
